...
function Footer() {
  return (
    <footer className=" px-20 font-[sans-serif] my-3">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <li>
              <a href="/">
                <svg
                  ...
                  className="fill-black hover:fill-[#444444] w-7 h-7"
                  viewBox="0 0 24 24"
                >
                  <path
                    fillRule="evenodd"
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li>
              <a href="/" className="text-black hover:text-[#444444] text-sm">
                Email
              </a>
            </li>
            <li>
      ...
      <p className="text-black text-sm mt-[#444444]">
        © 2023
        <a
